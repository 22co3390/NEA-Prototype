...
namespace FebAssess
{
    internal class APIs
    {
        ...
        static public string GetImage(int i)
        {
            int num = 0;
            foreach(EDAMAM e in list)
            {
                for(int l = 0; l< e.hits.Count; l++)
                {
                    if(i == num)
                    {
                        return e.hits[l].recipe.image;
                    }
                    num++;
                }
            }
        ...
        static public string GetText(int i)
        {
            int num = 0;
            foreach (EDAMAM e in list)
            {
